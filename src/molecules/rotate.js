...
export default class Rotate extends Atom {
  ...
  constructor(values) {
    ...
    this.addIO("input", "x-axis degrees", this, "number", 0.0001);
    this.addIO("input", "y-axis degrees", this, "number", 0.0001);
    this.addIO("input", "z-axis degrees", this, "number", 0.0001);
