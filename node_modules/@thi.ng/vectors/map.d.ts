import type { IVector, VecOpV, VecOpVN, VecOpVV, VecOpVVN, VecOpVVV } from "./api.js";
/**
 ...
 * @param sb -
 */
export declare const mapVV: (op: VecOpVV, out: IVector<any>, a: IVector<any>, b: IVector<any>, num: number, so?: number, sa?: number, sb?: number) => import("@thi.ng/api").NumericArray;
/**
 ...
 * @param sa -
 */
export declare const mapV: (op: VecOpV, out: IVector<any>, a: IVector<any>, num: number, so?: number, sa?: number) => import("@thi.ng/api").NumericArray;
/**
 ...
 * @param sa -
 */
export declare const mapVN: (op: VecOpVN, out: IVector<any>, a: IVector<any>, n: number, num: number, so?: number, sa?: number) => import("@thi.ng/api").NumericArray;
/**
 ...
 * @param sc -
 */
export declare const mapVVV: (op: VecOpVVV, out: IVector<any>, a: IVector<any>, b: IVector<any>, c: IVector<any>, num: number, so?: number, sa?: number, sb?: number, sc?: number) => import("@thi.ng/api").NumericArray;
/**
 ...
 * @param sb -
 */
export declare const mapVVN: (op: VecOpVVN, out: IVector<any>, a: IVector<any>, b: IVector<any>, n: number, num: number, so?: number, sa?: number, sb?: number) => import("@thi.ng/api").NumericArray;
