(function(global, factory) {
  ...
  const approximateAsBSpline = (adaptor, tolerance = 1e-8) => {
    const oc = getOC();
    const r = GCWithScope();
    const convert = r(
  ...
  const FONT_REGISTER = {};
  const loadFont = async (fontPath, fontFamily = "default") => {
  ...
  const drawPointsInterpolation = (points, approximationConfig = {}) => {
    return new Drawing(
      new Blueprint([make2dInerpolatedBSplineCurve(points, approximationConfig)])
    );
  };
  const drawParametricFunction = (func, { pointsCount = 400, start = 0, stop = 1 } = {}, approximationConfig = {}) => {
    const stepSize = (stop - start) / pointsCount;
    const points = [...Array(pointsCount + 1).keys()].map((t) => {
  ...
  exports2.AssemblyExporter = AssemblyExporter;
  exports2.BaseSketcher2d = BaseSketcher2d;
  exports2.Blueprint = Blueprint;
  exports2.BlueprintSketcher = BlueprintSketcher;
  exports2.Blueprints = Blueprints;
  exports2.BoundingBox = BoundingBox$1;
  exports2.BoundingBox2d = BoundingBox2d;
  exports2.CompSolid = CompSolid;
  exports2.Compound = Compound;
  exports2.CompoundBlueprint = CompoundBlueprint;
  exports2.CompoundSketch = CompoundSketch;
  exports2.CornerFinder = CornerFinder;
  exports2.Curve = Curve;
  exports2.Curve2D = Curve2D;
  exports2.DEG2RAD = DEG2RAD;
  exports2.Drawing = Drawing;
  exports2.DrawingPen = DrawingPen;
  exports2.Edge = Edge;
  exports2.EdgeFinder = EdgeFinder;
  exports2.Face = Face;
  exports2.FaceFinder = FaceFinder;
  exports2.FaceSketcher = FaceSketcher;
  exports2.GCWithObject = GCWithObject;
  exports2.GCWithScope = GCWithScope;
  exports2.HASH_CODE_MAX = HASH_CODE_MAX;
  exports2.LinearPhysicalProperties = LinearPhysicalProperties;
  exports2.Plane = Plane;
  exports2.ProjectionCamera = ProjectionCamera;
  exports2.RAD2DEG = RAD2DEG;
  exports2.Shape = Shape;
  exports2.Shell = Shell;
  exports2.Sketch = Sketch;
  exports2.Sketcher = Sketcher;
  exports2.Sketches = Sketches;
  exports2.Solid = Solid;
  exports2.Surface = Surface;
  exports2.SurfacePhysicalProperties = SurfacePhysicalProperties;
  exports2.Transformation = Transformation;
  exports2.Vector = Vector;
  exports2.Vertex = Vertex;
  exports2.VolumePhysicalProperties = VolumePhysicalProperties;
  exports2.Wire = Wire;
  exports2.WrappingObj = WrappingObj;
  exports2._1DShape = _1DShape;
  exports2._3DShape = _3DShape;
  exports2.addHolesInFace = addHolesInFace;
  exports2.asDir = asDir;
  exports2.asPnt = asPnt;
  exports2.assembleWire = assembleWire;
  exports2.axis2d = axis2d;
  exports2.basicFaceExtrusion = basicFaceExtrusion;
  exports2.cast = cast;
  exports2.combineFinderFilters = combineFinderFilters;
  exports2.complexExtrude = complexExtrude;
  exports2.compoundShapes = compoundShapes;
  exports2.createAssembly = createAssembly;
  exports2.createNamedPlane = createNamedPlane;
  exports2.cut2D = cut2D;
  exports2.cutBlueprints = cutBlueprints;
  exports2.downcast = downcast;
  exports2.draw = draw;
  exports2.drawCircle = drawCircle;
  exports2.drawEllipse = drawEllipse;
  exports2.drawFaceOutline = drawFaceOutline;
  exports2.drawParametricFunction = drawParametricFunction;
  exports2.drawPointsInterpolation = drawPointsInterpolation;
  exports2.drawPolysides = drawPolysides;
  exports2.drawProjection = drawProjection;
  exports2.drawRectangle = drawRectangle;
  exports2.drawRoundedRectangle = drawRoundedRectangle;
  exports2.drawSingleCircle = drawSingleCircle;
  exports2.drawSingleEllipse = drawSingleEllipse;
  exports2.drawText = drawText;
  exports2.exportSTEP = exportSTEP;
  exports2.fuse2D = fuse2D;
  exports2.fuseBlueprints = fuseBlueprints;
  exports2.genericSweep = genericSweep;
  exports2.getFont = getFont;
  exports2.getOC = getOC;
  exports2.importSTEP = importSTEP;
  exports2.importSTL = importSTL;
  exports2.intersect2D = intersect2D;
  exports2.intersectBlueprints = intersectBlueprints;
  exports2.isPoint = isPoint;
  exports2.isProjectionPlane = isProjectionPlane;
  exports2.isShape3D = isShape3D;
  exports2.isWire = isWire;
  exports2.iterTopo = iterTopo;
  exports2.loadFont = loadFont;
  exports2.localGC = localGC;
  exports2.loft = loft;
  exports2.lookFromPlane = lookFromPlane;
  exports2.makeAx1 = makeAx1;
  exports2.makeAx2 = makeAx2;
  exports2.makeAx3 = makeAx3;
  exports2.makeBSplineApproximation = makeBSplineApproximation;
  exports2.makeBaseBox = makeBaseBox;
  exports2.makeBezierCurve = makeBezierCurve;
  exports2.makeCircle = makeCircle;
  exports2.makeCompound = makeCompound;
  exports2.makeCylinder = makeCylinder;
  exports2.makeDirection = makeDirection;
  exports2.makeEllipse = makeEllipse;
  exports2.makeEllipseArc = makeEllipseArc;
  exports2.makeFace = makeFace;
  exports2.makeHelix = makeHelix;
  exports2.makeLine = makeLine;
  exports2.makeNewFaceWithinFace = makeNewFaceWithinFace;
  exports2.makeNonPlanarFace = makeNonPlanarFace;
  exports2.makeOffset = makeOffset;
  exports2.makePlane = makePlane;
  exports2.makePlaneFromFace = makePlaneFromFace;
  exports2.makePolygon = makePolygon;
  exports2.makeProjectedEdges = makeProjectedEdges;
  exports2.makeSolid = makeSolid;
  exports2.makeSphere = makeSphere;
  exports2.makeTangentArc = makeTangentArc;
  exports2.makeThreePointArc = makeThreePointArc;
  exports2.makeVertex = makeVertex;
  exports2.measureArea = measureArea;
  exports2.measureLength = measureLength;
  exports2.measureShapeLinearProperties = measureShapeLinearProperties;
  exports2.measureShapeSurfaceProperties = measureShapeSurfaceProperties;
  exports2.measureShapeVolumeProperties = measureShapeVolumeProperties;
  exports2.measureVolume = measureVolume;
  exports2.mirror = mirror;
  exports2.organiseBlueprints = organiseBlueprints;
  exports2.polysideInnerRadius = polysideInnerRadius;
  exports2.polysidesBlueprint = polysidesBlueprint;
  exports2.revolution = revolution;
  exports2.rotate = rotate;
  exports2.roundedRectangleBlueprint = roundedRectangleBlueprint;
  exports2.scale = scale;
  exports2.setOC = setOC;
  exports2.shapeType = shapeType;
  exports2.sketchCircle = sketchCircle;
  exports2.sketchEllipse = sketchEllipse;
  exports2.sketchFaceOffset = sketchFaceOffset;
  exports2.sketchHelix = sketchHelix;
  exports2.sketchParametricFunction = sketchParametricFunction;
  exports2.sketchPolysides = sketchPolysides;
  exports2.sketchRectangle = sketchRectangle;
  exports2.sketchRoundedRectangle = sketchRoundedRectangle;
  exports2.sketchText = sketchText;
  exports2.supportExtrude = supportExtrude;
  exports2.textBlueprints = textBlueprints;
  exports2.translate = translate;
  exports2.twistExtrude = twistExtrude;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
});
//# sourceMappingURL=replicad.umd.cjs.map
