...
var Module = (() => {
  ...
  return function(Module2) {
    ...
    var asmLibraryArg = { "_": OSD_MemInfo_getModuleHeapLength, "k": ___assert_fail, "a": ___cxa_allocate_exception, "b": ___cxa_throw, "S": ___syscall_chmod, "T": ___syscall_faccessat, "p": ___syscall_fcntl64, "M": ___syscall_fstat64, "V": ___syscall_ioctl, "J": ___syscall_lstat64, "K": ___syscall_newfstatat, "t": ___syscall_openat, "L": ___syscall_stat64, "B": __embind_register_bigint, "X": __embind_register_bool, "d": __embind_register_class, "f": __embind_register_class_class_function, "e": __embind_register_class_constructor, "c": __embind_register_class_function, "W": __embind_register_emval, "i": __embind_register_enum, "h": __embind_register_enum_value, "w": __embind_register_float, "j": __embind_register_integer, "g": __embind_register_memory_view, "v": __embind_register_std_string, "q": __embind_register_std_wstring, "Y": __embind_register_void, "P": __emscripten_date_now, "O": __emscripten_get_now_is_monotonic, "m": __emval_as, "la": __emval_call_method, "y": __emval_decref, "ma": __emval_get_global, "ka": __emval_get_method_caller, "r": __emval_get_property, "z": __emval_incref, "ja": __emval_new_cstring, "na": __emval_run_destructors, "n": __emval_set_property, "l": __emval_take_value, "x": __emval_typeof, "Q": __localtime_js, "G": __munmap_js, "R": __tzset_js, "s": _abort, "F": _emscripten_get_heap_max, "N": _emscripten_memcpy_big, "E": _emscripten_resize_heap, "H": _environ_get, "I": _environ_sizes_get, "$": _exit, "o": _fd_close, "U": _fd_read, "A": _fd_seek, "u": _fd_write, "Z": _gethostbyname, "ia": _glGetUniformLocation, "ga": _glUniform1f, "ha": _glUniform1i, "ca": _glUniform2fv, "fa": _glUniform2iv, "ba": _glUniform3fv, "ea": _glUniform3iv, "aa": _glUniform4fv, "da": _glUniform4iv, "C": _setTempRet0, "D": _strftime_l };
    var asm = createWasm();
    ...
    var dynCall_viijii = Module2["dynCall_viijii"] = function() {
      return (dynCall_viijii = Module2["dynCall_viijii"] = Module2["asm"]["Aa"]).apply(null, arguments);
    };
    var dynCall_iiiiij = Module2["dynCall_iiiiij"] = function() {
      return (dynCall_iiiiij = Module2["dynCall_iiiiij"] = Module2["asm"]["Ba"]).apply(null, arguments);
    };
    var dynCall_iiiiijj = Module2["dynCall_iiiiijj"] = function() {
      return (dynCall_iiiiijj = Module2["dynCall_iiiiijj"] = Module2["asm"]["Ca"]).apply(null, arguments);
    };
    var dynCall_iiiiiijj = Module2["dynCall_iiiiiijj"] = function() {
      return (dynCall_iiiiiijj = Module2["dynCall_iiiiiijj"] = Module2["asm"]["Da"]).apply(null, arguments);
    };
    var dynCall_viiiiji = Module2["dynCall_viiiiji"] = function() {
      return (dynCall_viiiiji = Module2["dynCall_viiiiji"] = Module2["asm"]["Ea"]).apply(null, arguments);
    };
    Module2["FS"] = FS;
    var calledRun;
...
export {
  replicad_single_default as default
};
//# sourceMappingURL=replicad-opencascadejs_src_replicad_single__js.js.map
