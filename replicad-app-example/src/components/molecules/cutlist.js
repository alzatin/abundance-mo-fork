...
export default class CutList extends Atom {
  ...
  constructor(values) {
     ...
     */
    this.description =
      "Adds a part to the cut list so that it will be included in the cut layout.";
  ...
  draw() {
    ...
    GlobalVariables.c.fillText(
      String.fromCharCode(0x2702) + " -",
      GlobalVariables.widthToPixels(this.x - this.radius / 1.5),
      GlobalVariables.heightToPixels(this.y) + this.height / 2
    );
